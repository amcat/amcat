...
print('Sentence 1:\t\t' + repr(a.sentence_set.all()[0]))
print('Sentence 2:\t\t' + repr(a.sentence_set.all()[1]))
print('Sentence 5:\t\t' + repr(a.sentence_set.all()[4]))
print('Project:\t\t' + repr(a.project))
print('Project insert user:\t' + repr(a.project.insert_user))

u = user.User.objects.get(id=2)
print('\nUser:\t\t\t' + repr(u))
print('Projects:\t\t' + repr(list(u.projects)))
print('Roles:\t\t\t' + repr(u.roles.all()))
print('Project roles:\t\t' + repr(u.projectrole_set.all()))

p = project.Project.objects.get(id=2)
print('\nProject:\t\t' + repr(p))
print('Users:\t\t\t' + repr(list(p.users)))
