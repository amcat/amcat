...
class TestProject(amcattest.AmcatTestCase):
    ...
    def testUpdateSQL(self):
        for table, where, newvals, result in (
            ...
            self.assertEqual(self.db._updateSQL(table, where, newvals), result)
    ...
    def testInsertUpdate(self):
        ...
        self.db.insert("#updatetest", dict(id=2, i=1, s='x', d=datetime.datetime(2010,1,1)),  retrieveIdent=False)
        ...
        self.assertEqual(data, [(1, 0, None, None),
                                ...
                                (2, 1, 'x', datetime.datetime(2010,1,1)),])
        ...
        self.assertEqual(data, [(1, 0, "bla'bla", datetime.datetime(1990,1,1)),
                                ...
                                (2, 1, 'x', datetime.datetime(1990,1,1)),])
