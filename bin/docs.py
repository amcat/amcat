...
# for some reason, importing django.test sets the clock 7 hours back (?!)
...
indexfile = INDEX.format(**locals())
log.info("Writing index file to {indexfile}".format(**locals()))
open(indexfile, "w").write(HTML.format(content=content))
