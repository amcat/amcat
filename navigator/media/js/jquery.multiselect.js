 ...
 * checked options are displayed on top of the list (very useful if there are a lot of options)
...
$.widget("ech.multiselect", {
	...
	open: function( e ){
        ...
        // ADDED FOR AmCAT
        // Hack to always keep the checked items first in the list, so they are easier to find
        if(this.labels.length > 10){
            this.labels.find('input:checked').parent().parent().prependTo(this.menu.find('ul.ui-multiselect-checkboxes'));
            this.menu.find('ul.ui-multiselect-checkboxes').scrollTop(0) // scroll to the top
        }
