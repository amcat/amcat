...
urlpatterns = format_suffix_patterns(patterns('',
    ...
    url(r'^projects/(?P<project>[0-9]+)/articlesets/articles-upload/$', ArticleUploadView.as_view(), name="project-article-upload"),
    url(r'^projects/(?P<project>[0-9]+)/articlesets/(?P<articleset>[0-9]+)/articles-upload/$', ArticleUploadView.as_view(), name="articleset-article-upload"),
