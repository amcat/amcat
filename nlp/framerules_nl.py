...
def getBronIdentifier(db):
    return getIdentifier(db, BRONRULES)
...
SPORULES = [
        SPORule('passief', condition=[isVNotZeg, isHighestV], postprocess=draai,
        ...
        SPORule('actief', condition=[isVNotZeg, isHighestV], postprocess=draai,
...
OTHERRULES = [
        DeclarativeRule(Goal, condition=[isDoelPredicate],                                                                                         
                        key = Self(),                                                                                                                 
        ...
        DeclarativeRule(Goal, condition=[isMeansPredicate,notPassiveVoice],                                                                                         
                        key = Self(),                                                                                                                 
        ...
        DeclarativeRule(Cause, condition=[isConsistent],                                                                                         
                        key = Self(),                                                                                                                 
                        dueTo = FirstMatch(Child("cnj"),Parent("mod")),
                        consequence = FirstMatch(Child("cnj"),Child("body")) ),
        DeclarativeRule(NegCause, condition=[isInconsistent],                                                                                         
                        key = Self(),                                                                                                                 
                        consequence = Parent("mod"),
                        despite = Child("body") ),
        DeclarativeRule(Assume, condition=[isPrecondition],                                                                                         
                        key = Self(),                                                                                                                 
        ...
        DeclarativeRule(Succession, condition=[isTimelyOrder],                                                                                         
                        key = Self(),                                                                                                                 
                        consequence = Parent("mod"),
...
ALLRULES = BRONRULES + SPORULES + OTHERRULES
